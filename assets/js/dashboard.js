...
btnAccion.addEventListener('click', () => {
    const categoriaSeleccionada = "Acción";
    const peliculasFiltradas = peliculas.filter(pelicula => pelicula.categoria === categoriaSeleccionada);

    // LIMPIAMOS EL CONTENEDOR PARA MOSTRAR LAS OTRAS
    ...
    peliculasFiltradas.forEach((pelicula, indice) => {
        ...
        tarjeta.addEventListener('click', () => {
            ...
            // CARGAR LA INFORMACIÓN DE LA PELÍCULA SELECCIONADA
            const pelicula = peliculasFiltradas[indice];
...
btnTerror.addEventListener('click', () => {
    const categoriaSeleccionada = "Terror";
    const peliculasFiltradas = peliculas.filter(pelicula => pelicula.categoria === categoriaSeleccionada);
